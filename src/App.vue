<template>
   <!-- start header -->
            ...
            <div class="container-fluid">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown dropdown-with-icon-style02">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a href="services-details.html"><i class="bi bi-briefcase"></i>Data analytics</a></li>
                                    <li><a href="services-details.html"><i class="bi bi-clipboard-data"></i>Finance consulting</a></li>
                                    <li><a href="services-details.html"><i class="bi bi-peace"></i>Technology innovation</a></li>
                                    <li><a href="services-details.html"><i class="bi bi-bar-chart-line"></i>Digital commerce</a></li>
                                    <li><a href="services-details.html"><i class="bi bi-send-check"></i>Artificial intelligence</a></li>
                                    <li><a href="services-details.html"><i class="bi bi-globe2"></i>Cloud computing</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-auto col-xxl-3 col-lg-2 text-end d-none d-sm-flex">
                    <div class="header-icon">
                        <div class="header-button"><a href="contact.html" class="btn btn-large btn-transparent-white-light btn-rounded text-transform-none border-1">Start a project<i class="fa-solid fa-arrow-right"></i></a></div>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <!-- end header -->
    <!-- start hero section -->
    <section class="cover-background full-screen ipad-top-space-margin py-0 md-h-750px sm-h-650px" style="background-image:url('/images/homepage-image.jpg');">
        ...
        <div class="container h-100">
            <div class="row align-items-center h-100">
                <div class="col-xl-6 col-lg-8 col-md-10 position-relative z-index-1" data-anime='{ "el": "childs", "translateY": [0, 0], "perspective": [1200,1200], "scale": [1.05, 1], "rotateX": [30, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <div>
                        <p class="fw-300 fs-18 w-85 sm-w-95 text-white opacity-6">We're a fully dedicated corporate service agency collaborating with brands all over the world.</p>
                    </div>
    ...
    <section class="pt-3 sm-pt-50px">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center mb-7" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <div class="col icon-with-text-style-01 md-mb-30px" v-for="post in posts" :key="post.id">
                    <div class="feature-box feature-box-left-icon last-paragraph-no-margin">
                        <div class="feature-box-icon me-20px">
                            <img :src="post.featured_media_url || 'https://placehold.co/80x80'" alt="" />
                        </div>
                        <div class="feature-box-content">
                            <span class="d-inline-block fs-18 text-dark-gray fw-700 mb-5px" v-html="post.title.rendered"></span>
                            <p class="w-80 xl-w-90 lg-w-100" v-html="post.excerpt.rendered"></p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                        <div class="position-relative">
                                            <a href="services-details.html"><img src="https://placehold.co/600x440" alt=""></a>
                                        ...
                                        <div class="bg-white">
                                            <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                <a href="services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Data and analytics</a>
                                            ...
                                            <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                <a href="services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                    <span>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                        ...
                                        <div class="bg-white">
                                            <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                <a href="services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Finance consulting</a>
                                                <p>Lorem ipsum simply dummy text of amet consectetur.</p>
                                            </div>
                                            <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                <a href="services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                        ...
                                        <div class="bg-white">
                                            <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                <a href="services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Tech innovation</a>
                                                <p>Lorem ipsum simply dummy text of amet consectetur.</p>
                                            </div>
                                            <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                <a href="services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                        ...
                                        <div class="bg-white">
                                            <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                <a href="services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Digital commerce</a>
                                                <p>Lorem ipsum simply dummy text of amet consectetur.</p>
                                            </div>
                                            <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                <a href="services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="services-box-style-03 last-paragraph-no-margin border-radius-4px overflow-hidden">
                                        ...
                                        <div class="bg-white">
                                            <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                <a href="services-details.html" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Cloud computing</a>
                                                <p>Lorem ipsum simply dummy text of amet consectetur.</p>
                                            </div>
                                            <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                <a href="services-details.html" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
            ...
            <div class="row align-items-center justify-content-center g-0" data-anime='{  "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="col-auto d-flex align-items-center">
                    ...
                    <div class="fs-17 lh-26 last-paragraph-no-margin text-white pt-15px pb-15px fw-500">
                        <p>Save your precious time and effort spent for finding a solution. <a href="contact.html" class="text-decoration-line-bottom text-white">Contact us now</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- end section -->
    <!-- start section -->
    <section class="cover-background one-third-screen sm-h-500px pb-0 position-relative" style="background-image:url('https://placehold.co/1920x760');">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 p-60px pt-40px pb-40px xs-p-30px xs-pt-30px xs-pb-30px position-relative box-shadow-quadruple-large bg-white border-radius-10px">
                    <div class="row">
                        ...
                        <div class="col-12 newsletter-popup position-relative">
                            ...
                            <a href="contact.html" class="btn btn-extra-large btn-gradient-purple-pink btn-rounded btn-box-shadow d-block mt-30px">Let's talk now <i class="fa-solid fa-arrow-right"></i></a>
            ...
            <div class="row justify-content-center pt-5 sm-pt-40px">
                ...
                <div class="col-6 col-xl-2 col-lg-3 col-sm-4 xs-mb-30px order-sm-3 order-lg-2">
                    ...
                    <ul>
                        ...
                        <li><a href="case-studies.html">Our clients</a></li>
